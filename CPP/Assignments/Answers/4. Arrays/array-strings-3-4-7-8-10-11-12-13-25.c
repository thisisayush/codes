/* Assignment 4 3.  Wap to read a string from user and show the character one by one? (Done)
				...
				25.	Wap to count the number of occurrences of a given character in a string. (Done)
...
void search(char *str,char ch) {
	...
	printf("\n\nTotal Occurences: %d",totalOccurence);
}
...
void concatenate(char *str1, char *str2){
	...
	printf("\nConactenated String is %s",startAddr);
}
